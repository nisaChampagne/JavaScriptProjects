...
const HomepageHeading = ({ mobile }) => (
  <Container >
    ...
    />
    <NavLink to="/"  exact className="notification_link" >
      ...
      <Grid container stackable verticalAlign='middle'>
        <Grid.Row>
          <Grid.Column width={8}>
            ...
            <List link inverted >
                <List.Item><NavLink to="/autocomplete" exact className="project_link" style={{color: 'white', textDecoration: 'none'}}>Auto Complete</NavLink></List.Item>
